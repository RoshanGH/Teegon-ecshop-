...
$payment_lang = ROOT_PATH . 'languages/' .$GLOBALS['_CFG']['lang']. '/payment/tiangongwx.php';
...
if (isset($set_modules) && $set_modules == TRUE)
{
    ...
    /* 描述对应的语言项 */
    $modules[$i]['desc']    = 'tiangongwx_desc';
    ...
    $modules[$i]['config']  = array(
        array('name' => 'tiangongwx_client_id',           'type' => 'text',   'value' => ''),
        array('name' => 'tiangongwx_client_secret',           'type' => 'text',   'value' => ''),
    );
...
class tiangongwx
{
    ...
    function get_code($order, $payment)
    {
       ...
       // $param['return_url'] = 'http://www.qq.com';
        ...
        $param['client_id'] = $payment['tiangongwx_client_id'];
...
//tiangong 加密算法
    public function sign($para_temp,$payment){
        ...
        $prestr = $payment['tiangongwx_client_secret'] .$prestr . $payment['tiangongwx_client_secret'];
